    ...
    <div class="py-12 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            {{-- <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg"> --}}
                ...
                <a class="px-4 py-2  rounded-md bg-gray-400" href="{{ route('admin.permissions.create') }}">Crear Permiso</a>
                <!-- component -->
                <link
                        ...
                        <table class="w-full table text-gray-400 border-separate {{-- space-y-6  --}} text-sm">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-gray-800">
                                    ...
                                    <td class="p-3 ">
                                        <a href="{{ route('admin.permissions.edit', $permission->id) }}" class="text-gray-400 hover:text-gray-100  mx-2">
                                            <i class="material-icons-outlined text-base">edit</i>
                                        </a>
                                        <form class="text-gray-400 hover:text-gray-100  ml-2" method="POST" action="{{ route('admin.permissions.destroy', $permission->id) }}" onsubmit="return confirm('¿Quieres eliminar este permiso?');">
                                            @csrf
                                            @method('DELETE')
